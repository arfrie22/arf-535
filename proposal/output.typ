...
The project will be developed in Rust with the slint UI library. The project will be hosted on GitHub and make use of the GitHub projects to keep track of work to do (kanban-esque board). 
