...
with open('instructions.json') as f:
    ...
    rule_names = []
    rules = ""
    parses = "            Rule::EOI => continue,\n"
    parses += "            Rule::label_arg => {\n"
    parses += "                labels.insert(p.as_str().to_owned(), instructions.len() as u32);\n"
    parses += "            },\n"
    ...
    output_file_rs.write("use crate::{parse_label, parse_number, AssemblerError, AssemblerParser, Rule};\n\n")
