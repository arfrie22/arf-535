...
pub enum Instruction {
    ...
    AddUnsignedInteger { c: u32, rx: Register, ry: Register, rz: Register },
...
impl From<u32> for Instruction {
    fn from(value: u32) -> Self {
        match value >> 24 {
            ...
            0x82 => Self::AddUnsignedInteger { c: (value >> 23) & 0x1, rx: Register::try_from(((value as usize) >> 18) & 0x1f).unwrap(), ry: Register::try_from(((value as usize) >> 13) & 0x1f).unwrap(), rz: Register::try_from(((value as usize) >> 8) & 0x1f).unwrap() },
...
impl Into<u32> for Instruction {
    fn into(self) -> u32 {
        match self {
            ...
            Self::AddUnsignedInteger { c, rx, ry, rz } => (0x82 << 24)| (c << 23)| ((rx as u32) << 18)| ((ry as u32) << 13)| ((rz as u32) << 8),
