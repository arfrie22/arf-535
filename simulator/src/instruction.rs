...
impl Instruction {
    pub fn read_registers(&self) -> RegisterSet {
        match self {
            ...
            Self::FloatingPointStoreData { rx, .. } => RegisterSet{ registers: vec![*rx], f_registers: vec![], timers: vec![]  },
            ...
            Self::BitwiseNOT { ry, rz, .. } => RegisterSet{ registers: vec![*ry, *rz], f_registers: vec![], timers: vec![]  },
    ...
    pub fn write_registers(&self) -> RegisterSet {
        match self {
            ...
            Self::FloatingPointLoadData { rx, .. } => RegisterSet{ registers: vec![*rx], f_registers: vec![], timers: vec![]  },
